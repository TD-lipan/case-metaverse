...
export default function () {
    ...
    return (
        <>
            ...
            <div className={styles.channelDropdown} style={{ display: showChannelDropdown ? 'block' : 'none' }}>
                <img src={channelDropdown} />
                <div className={styles.list}>
                    <div className={styles.item}></div>
                    <div className={styles.item} onClick={() => hanldeChange(channelLivechatToolbar)}></div>
                    <div className={styles.item} onClick={() => hanldeChange(channelEmailToolbar)}></div>
                </div>
            </div>
        </>
    );
