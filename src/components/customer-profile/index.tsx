...
export default function ({ left = 650, top = 244, visible = true, isDraged, isEmpty = true }: { left?: number, top?: number, visible?: boolean, isDraged: boolean, isEmpty: boolean }) {
    ...
    return (
        <div className={styles.customerProfile} style={{ top: top + 'px', left: left + 'px', display: visible ? 'block' : 'none' }}>
            ...
            <img src={(src === profile1_1 && isEmpty) ? profile1_0 : (src === profile1_1 && isDraged) ? profile1_2 : src} />
        </div>
    );
}
